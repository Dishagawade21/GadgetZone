...
urlpatterns = [
                  ...
                  path('decrease_product_quantity/', app.views.decrease_product_quantity, name='decrease_product_quantity'),
                  path('generate-pdf/', app.views.generate_pdf, name='generate_pdf'),
